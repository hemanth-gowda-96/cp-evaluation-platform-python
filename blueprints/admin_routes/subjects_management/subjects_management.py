...
from blueprints.admin_routes.subjects_management.services import subjects_services

bp = Blueprint('subjects_management', __name__,
               url_prefix='/admin/subjects-management')
...
def evaluators_management():
    ...
    return render_template('admin/subjects_management/search.html', subjects=subjects)
